...
#записали различные вариации пятерки
...
# Инициализация весов сети, по индексам до 15 элемента каждому значенияю приписываем вес = 0
weights = [0 for i in range(15)]

# Инициализация весов сети, то же самое, но подробно в виде цикла
#weights = []
#for i in range(15):
#    weights.append(0)

# Порог функции активации, Если взвешенная сумма будет больше или равна ему, то сеть выдаст 1 (что означает, что она считает предоставленную цифру пятеркой). Порог можно выбрать любой.
bias = 7
